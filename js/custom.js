...
$(document).ready(function () {
    ...
    $(document).on("click", ".product_grid_content .toggle_visibility", function (e) {
        var grid_content = $(".product_grid_content");
        if (grid_content.hasClass("filter_hidden")) {
            grid_content.addClass("animation");
            grid_content.addClass("opening");
            setTimeout(function () {
                grid_content.removeClass("filter_hidden");
                grid_content.removeClass("animation");
            }, 500);
        } else {
            grid_content.removeClass("opening");
            grid_content.addClass("animation");
            setTimeout(function () {
                grid_content.removeClass("animation");
                grid_content.addClass("filter_hidden");
            }, 500);
        }
        e.preventDefault();
    });
